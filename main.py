...
if __name__ == '__main__':
    ...
    # Directories
    parser.add_argument('--model_name', default='MSDPN', type=str)
    ...
    parser.add_argument('--save_freq', type=int, default=5, help='Frequency of saving the model.')
